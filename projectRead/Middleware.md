...
# Middleware and handle errors

Add Middleware
Edit auth.controller.js to include **next** in the async variables

    export const sighnup = async (requ, res, next) =>{


Create *R:\BasicMERNapp\api\utils\error.js*
